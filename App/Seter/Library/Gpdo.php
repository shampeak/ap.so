...
//        self::$dbhost = $dbi['dbhost'];
//        self::$dbport = $dbi['dbport'];
//        self::$dbname = $dbi['dbname'];
//        self::$dbuser = $dbi['dbuser'];
//        self::$dbpass = $dbi['dbpass'];
//        require_once 'config.inc.php';
        self::$dbhost = '127.0.0.1';
        self::$dbport = '3306';
        self::$dbname = 'gracemain';
        self::$dbuser = 'root';
        self::$dbpass = 'root';
        self::connect();
        //unset($dbi);
