...
(function() {               // Using a closure to keep global namespace clean.
    ...
    TrimPath.parseTemplate_etc.modifierDef = {
		"dt"		 : function(s)    { if(s > 0)return date('Y-m-d',s);},
		"dts"		 : function(s)    { if(s > 0)return date('Y-m-d H:i:s',s);},
		"today"		 : function(s)    { 
			var now = new Date();
		...
		//"count"		 : function(s)	  { if(isArray(s)){return s.length}else{return 0}},
		"se"			 : function(s)	  { 
        ...
        "HTMLDecode" : function(s)    { return HTMLDecode(s); },
