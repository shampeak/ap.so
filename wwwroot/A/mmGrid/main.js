$(document).ready(function(){
    ...
    var fixed3 = function(val){
        return '<a class="testa">'+val+'</a>';
    }
    ...
    var cols = [
        ...
        { title:'今收盘', name:'CLOSINGPRICE' ,width:60, align:'right', renderer: fixed3},
...
//console.log($('.mmg-index'));//btnPrice
